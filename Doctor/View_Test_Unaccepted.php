...
<body>
    ...
    <div id="wrapper">
						...
						<tr>
							...
							<th>QR Code</th>
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $d1 = date('Y-m-d');
                                            $qry = "SELECT * FROM donor,Test WHERE Test.national_id=donor.national and CONCAT(donor.name) LIKE '$filtervalues%' and Test.date_view='$d1' and Test.status = 'No' ";
		...
		";
                                            ...
                                            $qry = "SELECT * FROM donor,Test WHERE Test.national_id=donor.national and Test.date_view='$d1' and Test.status = 'No' ";
                                            $result = mysqli_query($conn, $qry);
