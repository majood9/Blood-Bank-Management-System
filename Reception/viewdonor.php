...
<body>
	...
	<div id="wrapper">
						...
						<tr>
							...
							<th>QR Code</th>
										...
										if (isset($_GET['search'])) {
											...
											$qry = "SELECT * FROM donor,status WHERE status.national=donor.national and CONCAT(name) LIKE '$filtervalues%' ";
		...
		// 								} 
											...
											$qry = "select * from donor, status where status.national=donor.national ";
											$result = mysqli_query($conn, $qry);
