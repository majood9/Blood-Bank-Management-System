...
<body>
	...
	<div id="wrapper">
					...
					<div class=".col-lg-12">
						<div class="panel panel-default">
							...
							<div class="panel-heading">
								...
								<form action="view_substitute_donor.php" method="" style="display:inline;">
						...
						<tr>
							...
							<th>QR Code</th>
										...
										if (isset($_GET['search'])) {
											...
											$qry = "SELECT * FROM donor,status WHERE status.national=donor.national and status.donation_reason='substitute'  and CONCAT(donor.name) LIKE '$filtervalues%' ";
		...
		// 								 if (isset($_POST['donation_reason'])) {
		// 									// if($_POST['donation_reason']=='Voluntary'){
		// 									$m = $_POST['donation_reason'];


		// 									// $filtervalues = $_GET['search'];
		// 									$qry = "SELECT * FROM donor,status WHERE status.national=donor.national and status.donation_reason='$m' ";
		// 									$result = mysqli_query($conn, $qry);
		...
		// 								} 
											...
											$qry = "select * from donor, status where status.national=donor.national and status.donation_reason='substitute' ";
											$result = mysqli_query($conn, $qry);
