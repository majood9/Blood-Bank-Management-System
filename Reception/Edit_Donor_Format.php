...
<body>
    ...
    <div id="wrapper">
        ...
        $qry = "select * from donor,status where donor.national='$national' and status.national=$national";
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <form role="form" action="Edited_Donor.php" method="post" style=" margin-right: 20px; ">
                                        ...
                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl; margin-top: 20px;">
                                            ...
                                            <input style="text-align: center; color:darkred;flex: 1; margin-left: 470px;" class="form-control" name="date_view" type="text" value="<?php echo $row['date_view']; ?>">
                                        </div>


                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                            <label style="flex: 1; padding: 7px;">civil id</label>
                                            <input style="text-align: center;flex: 1; margin-left: 470px;" class="form-control" name="national" value="<?php echo $row['national']; ?>" required>
                                        ...
                                        <div class="form-group" style="margin-left: 150px; display: flex; flex-direction: row; direction: rtl;">
                                            ...
                                            <input style="text-align: center;flex: 1.05;  margin-left: 95px; width: 50%;" class="form-control" name="name" type="text" value="<?php echo $row['name']; ?>" required>

                                            <label style="padding: 7px;">النسبة<span style="color: red;">*</span></label>
                                            <input style="text-align: center;flex: 1.05; width: 50%;" class="form-control" name="name_family" type="text" value="<?php echo $row['name_family'];; ?>" required>
                                        </div>
                                        <div class="form-group" style="margin-left: 150px; display: flex; flex-direction: row; direction: rtl;">
                                            <label style="flex: 0.5; padding: 7px;">اسم الأب<span style="color: red;">*</span></label>
                                            <input style="text-align: center;flex: 1.05;  margin-left: 60px; width: 50%;" class="form-control" name="name_father" type="text" value="<?php echo $row['name_father']; ?>" required >

                                            <label style=" padding: 7px;">اسم ونسبة الأم<span style="color: red;">*</span></label>
                                            <input style="text-align: center;flex: 1.05; width: 50%;" class="form-control" name="name_mother" value="<?php echo $row['name_mother']; ?>" type=" text" required>
                                        </div>

                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                            <label style="flex: 1; padding: 7px;">تاريخ الميلاد<span style="color: red;">*</span></label>
                                            <input style="text-align: center;flex: 2.1; margin-left: 470px;" class="form-control" name="dob" type="date" value="<?php echo $row['dob'];; ?>" oninput="calculateAge()" required >
                                        </div>

                                        <div class="form-group" style="margin-left: 150px; display: flex; flex-direction: row; direction: rtl;">
                                            <label style="flex: 0.5; padding: 7px;">السن<span style="color: red;">*</span></label>
                                            <input style="text-align: center;flex: 1.05; margin-left: 95px; width: 50%;" class="form-control" name="age" type="number" min="0" max="120" value="<?php echo  date('Y-m-d')-$row['dob'];; ?>"  readonly required>

                                            <label style="padding: 7px;">الجنس<span style="color: red;">*</span></label>
                                            <select style="text-align: center;flex: 1.05; width: 50%;" class="form-control" name="gender" type="text" value="<?php echo $row['gender']; ?>" required>
                                       ...
                                       // $uniqueId = sprintf("%06d", mt_rand(1, 99999));
                                        ...
                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                            ...
                                            <input style="color:darkred ;text-align: center;flex: 1; margin-left: 470px;" class="form-control" name="Donation_code" value="<?php echo $row['Donation_code']; ?>">
                                        </div>


                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                            <label style="flex: 1; padding: 7px;">العنوان <span style="color: red;">*</span></label>
                                            <input style="text-align: center;flex: 1; margin-left: 470px;" class="form-control" name="address" value="<?php echo $row['address']; ?>" required>
                                        ...
                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                            ...
                                            <input style="text-align: center;flex: 1; margin-left: 470px;" class="form-control" value="<?php echo $row['phone_number']; ?>" name="phone_number">

                                            </input>
                                        </div>
                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                            <label style="flex: 1; padding: 7px;">سبب التبرع<span style="color: red;">*</span></label>
                                            <select style="text-align: center;flex: 2.1; margin-left: 470px;" class="form-control" name="donation_reason" value="<?php echo $row['donation_reason']; ?>"required>
                                                <option value="<?php echo $row['donation_reason']; ?>"><?php echo $row['donation_reason']; ?></option>
