...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Distinguished Donors
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <?php 
        include "dbconnect.php";
        $query         = mysqli_query($conn, "SELECT * FROM donor,status where donor.national=status.national having count(*) > 3");
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="text-info">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
                                    <i class="icofont-user icofont-5x" style="color:rgba(220, 20, 60, 0.8); size:100%;"></i>
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div><?php echo  "$name"." ". $name_family; ?></div>
                                    <div style="color:rgba(220, 20, 60, 0.8);">Distinguished Donor</div>
                                </div>
                            </div>
                        </div>
                        <a href="View_Donor_Blanche.php?national=<?php echo  $national; ?>">
