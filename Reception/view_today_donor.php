                    ...
                    <div class=".col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                ...
                                <form action="view_today_donor.php" method="" style="display:inline;">
						...
						<tr>
							...
							<th>QR Code</th>
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $d1 = date('Y-m-d');
                                            $qry = "SELECT * FROM donor,status WHERE status.national=donor.national and status.date_view='$d1' and donor.date_view='$d1' and CONCAT(name) LIKE '$filtervalues%'    ";
