...
<body>
	...
	<div id="wrapper">
					...
					<div class=".col-lg-12">
						<div class="panel panel-default">
							...
							<div class="panel-heading">
								...
								<form action="view_voluntary_donor.php" method="" style="display:inline;">
						...
						<tr>
							...
							<th>QR Code</th>
										...
										if (isset($_GET['search'])) {
											...
											$qry = "SELECT * FROM donor,status WHERE status.national=donor.national and status.donation_reason='Voluntary' and CONCAT(name) LIKE '$filtervalues%' ";
		...
		// 								} 
											...
											$qry = "select * from donor, status where status.national=donor.national and status.donation_reason='Voluntary' ";
											$result = mysqli_query($conn, $qry);
