...
<body>
    ...
    <div id="wrapper">
						...
						<tr>
							...
							<th>QR Code</th>
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $d = date('Y-m-d');
                                            $qry = "SELECT * FROM Blood WHERE Picking_Type='Single' and Donation_Date = '$d' and CONCAT(Donation_Number) LIKE '$filtervalues%' ";
		...
		";
                                            ...
                                            $qry = "select * from Blood where Picking_Type='Single' and Donation_Date = '$d'  ";
                                            $result = mysqli_query($conn, $qry);
