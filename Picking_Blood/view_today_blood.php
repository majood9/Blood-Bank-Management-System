...
<body>
    ...
    <div id="wrapper">
                    ...
                    <div class=".col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                ...
                                <form action="view_today_blood.php" method="" style="display:inline;">
						...
						<tr>
							...
							<th>QR Code</th>
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $qry = "SELECT * FROM Blood WHERE Donation_Date='$d1' and CONCAT(Donation_Number) LIKE '$filtervalues%' ";
		...
		";
                                            ...
                                            $qry = "select * from Blood where Donation_Date='$d'  ";
                                            $result = mysqli_query($conn, $qry);
