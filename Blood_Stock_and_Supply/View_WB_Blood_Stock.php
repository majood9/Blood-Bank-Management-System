                    ...
                    <div class=".col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                ...
                                <form action="View_WB_Blood_Stock.php" method="" style="display:inline;">
						...
						<tr>
							...
							<th>QR Code</th>
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $qry = "SELECT * FROM Blood_Stock WHERE Unit_Type='WB' and CONCAT(Unit_Type) LIKE '$filtervalues%' ";
                                            ...
                                            $qry = "select * from Blood_Stock where Unit_Type='WB'  ";
                                            $result = mysqli_query($conn, $qry);
