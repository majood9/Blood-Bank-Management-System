    ...
    <div id="wrapper"> 
        ...
        <script>
            ...
            scanner.addListener('scan', function(content) {
                fetch('Add_Blood_Stock.php?qrData=')
                    .then(response => response.text())
                    .then(data => {
                        window.location.href = "Add_Blood_Stock.php?qrData=" + content;
                    });
            });
                                    ...
                                    <form role="form" action="addtest.php" method="post">
                                        ...
                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                          <label style="flex: 1; padding: 7px;margin-right:35px;">كود مكون الدم  <span style="color: red;">*</span></label> 
                                            <input placeholder="كود مكون الدم" style="text-align: center;flex: 1; margin-left: 465px; color:darkred;" class="form-control"; name="national"; type="text"  required><br><br>
