    ...
    <div id="wrapper"> 
        ...
        <script>
            ...
            scanner.addListener('scan', function(content) {
                fetch('Add_Release_Blood.php?qrData=')
                    .then(response => response.text())
                    .then(data => {
                        window.location.href = "Add_Release_Blood.php?qrData=" + content;
                    });
            });
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <form role="form" action="Add_Release_Blood.php" method="post">
                                        ...
                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                          <label style="flex: 1; padding: 7px;margin-right:35px;">كود الوحدة <span style="color: red;">*</span></label> 
                                            <input placeholder="كود الوحدة"  style="text-align: center;flex: 1; margin-left: 465px; color:darkred;" class="form-control"; name="Unit_Number"; type="text"  required><br><br>
                                              
                                            </input>
                                        </div><br>
                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                          <label style="flex: 1; padding: 7px;margin-right:35px;">كود مكون الدم  <span style="color: red;">*</span></label> 
                                            <input placeholder="كود مكون الدم" style="text-align: center;flex: 1; margin-left: 465px; color:darkred;" class="form-control"; name="Donation_Number"; type="text"  required><br><br>
...
<thead>
                        ...
                        <tbody>
                         <tr style="text-align:center;color:darkred;">
						  <td name="Expiry_Date"></td>
						  <td name="Blood_Amount"></td>
						  <td name="Unit_Type"></td>
                          <td name="Blood_Group"></td>
                          <td name="Unit_Number"></td>
                          <td name="Donation_Number"></td>
