    ...
    <div id="wrapper"> 
     ...
     ?>
                                         <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                            ...
                                            <input style="text-align: center; color:blue;flex: 1; margin-left: 462px;" class="form-control" name="date_view"; type="text"; value="<?php echo $uniqueId; ?>"readonly><br><br>
                                        </div>
                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                          <label style="flex: 1; padding: 7px;margin-right:35px;">رقم التبرع <span style="color: red;">*</span></label> 
                                            <input  style="text-align: center;flex: 1; margin-left: 463px; color:blue;" class="form-control"; name="national"; type="text"  required><br><br>
...
<div style="margin-right:349px;">
    <label style= "font-size:17px;"> <select style="font-size:12px; color:red; border-radius:8px; width: 90px; height: 30px; text-align: center;" name="volume"; type="text"; required >
                                                    <option value=""></option>
...
<div id="hiddenSection" style="display: none;">
  <div style="text-align:left;margin-left:37px;">
    <label style= "font-size:17px;"> <select style="font-size:12px; color:red; border-radius:8px; width: 90px; height: 30px; text-align: center;" name="volume"; type="text"; >
                                                    <option value=""></option>
