						...
						<tr>
							...
							<th>QR Code</th>
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $qry = "SELECT * FROM Blood_Test WHERE Test_HBsAg='negative' and Test_HCV_Ab_IgG='negative' and Test_HIV_1_2_Ag_Ab='negative' and Test_Syphilis_Ab='negative' and Test_Date='$d' and CONCAT(Donation_Number) LIKE '$filtervalues%' ";
                                            ...
                                            $qry = "select * from Blood_Test WHERE Test_HBsAg='negative' and Test_HCV_Ab_IgG='negative' and Test_HIV_1_2_Ag_Ab='negative' and Test_Syphilis_Ab='negative' and Test_Date='$d' ";
                                            $result = mysqli_query($conn, $qry);
