						...
						<tr>
							...
							<th>QR Code</th>
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $qry = "SELECT * FROM Blood_Test WHERE Test_HBsAg='positive' or Test_HCV_Ab_IgG='positive' or Test_HIV_1_2_Ag_Ab='positive' or Test_Syphilis_Ab='positive' and CONCAT(Donation_Number) LIKE '$filtervalues%' ";
                                            ...
                                            $qry = "select * from Blood_Test WHERE Test_HBsAg='positive' or Test_HCV_Ab_IgG='positive' or Test_HIV_1_2_Ag_Ab='positive' or Test_Syphilis_Ab='positive' ";
                                            $result = mysqli_query($conn, $qry);
