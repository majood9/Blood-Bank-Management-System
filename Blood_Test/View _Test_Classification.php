						...
						<tr>
							...
							<th>QR Code</th>
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $qry = "SELECT * FROM Blood_Test WHERE Test_Date='$d' and CONCAT(Donation_Number) LIKE '$filtervalues%' ";
                                            ...
                                            $qry = "select * from Blood_Test where Test_Date='$d' and (Stereotyping_Capital_C = 'C+' or Stereotyping_Capital_C = 'C-' or Stereotyping_Capital_E = 'E+' or Stereotyping_Capital_E = 'E-' or Stereotyping_Small_c = 'c+'  or Stereotyping_Small_c = 'c-' or Stereotyping_Small_e = 'e+' or Stereotyping_Small_e = 'e-' or Stereotyping_Capital_K = 'K+' or Stereotyping_Capital_K = 'K-' )   ";
                                            $result = mysqli_query($conn, $qry);
