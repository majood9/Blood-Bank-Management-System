                                        ...
                                        ?>
                                            <form role="form" action="#" method="post" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="<?php echo $Unit_Number ?>" name="Unit_Number" required disabled>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="<?php echo $Separation_Date ?>" name="Separation_Date" required disabled>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="<?php echo $Unit_Type ?>" name="Unit_Type" required disabled>
                                                </div>
                                                <div class="form-group">
                                                    <label>Unit Amount</label>
                                                    <input class="form-control" placeholder="<?php echo $Unit_Amount ?>" name="Unit_Amount" required disabled>
                                                </div>
                                                ...
                                                <button type="submit" class="btn btn-success" class="btn btn-success" style="border-radius:0%; margin-left:75%"> <a href="uploadPrint.php?Unit_Number=<?php echo $row['Unit_Number'] ?>" style="color:white;">Print QR Code</a></button>
