            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class=".col-lg-12">
                        ...
                        <h6 class="page-header">Department:<span style="color: blue; "> Blood Separation </span> </h6>
                        <img src="../img/Blood Separation.png " style=" width: 200px; margin-left: 470px; margin-top: -40px; ">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        $qry = "select * from Blood_Separation where Separation_Date='$d'  ";
