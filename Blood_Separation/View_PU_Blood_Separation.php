						...
						<tr>
							...
							<th>QR Code</th>
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $d = date('Y-m-d');
                                            $qry = "SELECT * FROM Blood_Separation WHERE Unit_Type='PU' and Separation_Date = '$d' and CONCAT(Unit_Number) LIKE '$filtervalues%' ";
                                            ...
                                            $qry = "select * from Blood_Separation where Unit_Type='PU' and Separation_Date = '$d'  ";
                                            $result = mysqli_query($conn, $qry);
