    ...
    <div id="wrapper"> 
        ...
        <script>
            ...
            scanner.addListener('scan', function(content) {
                fetch('destroy_blood_group.php?qrData=')
                    .then(response => response.text())
                    .then(data => {
                        window.location.href = "destroy_blood_group.php?qrData=" + content;
                    });
            });
                                    ...
                                    <form role="form" action="addtest.php" method="post">
                                        ...
                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                          ...
                                          <label style="flex: 1; padding: 7px;margin-right:35px;">السبب ١<span style="color: red;"> *</span></label> 
                                            <select placeholder="سبب الإتلاف"  style="text-align: center;flex: 1; margin-left: 503px; color:darkred;" class="form-control"; name="national"; type="text"  required><br><br>
                                                  <option value=""></option>
                                                  <option value="كيس تلف"><span>كيس تلف</span></option>
                                                  <option value=" فشل في  القطف "><span>فشل في القطف</span></option>
                                                  <option value="فشل في الإختبار"><span>فشل في الإختبار</span></option>
                                                  <option value="فشل في الفصل"><span>فشل في الفصل</span></option>
                                        ...
                                        <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                          <label style="flex: 1; padding: 7px;margin-right:35px;">كود التبرع <span style="color: red;">*</span></label> 
                                            <input placeholder="كود التبرع"  style="text-align: center;flex: 1; margin-left: 465px; color:darkred;" class="form-control"; name="national"; type="text"  required><br><br>
