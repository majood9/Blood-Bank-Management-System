            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class=".col-lg-12">
                        ...
                        // $qry = "SELECT * FROM Destroy_Blood_Unit ";
                        ...
                        // if($result->num_rows > 0){
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $qry = "SELECT * FROM Destroy_Blood_Unit WHERE U_Destruction_Date = '$d' and CONCAT(Unit_Type) LIKE '$filtervalues%' ";
                                            $result = mysqli_query($conn, $qry);
...
<tr>
          <td>" . $row['U_Destruction_Number'] . "</td>
          <td>" . $row['Unit_Number'] . "</td>
          <td>" . $row['U_Destruction_Date'] . "</td>
          <td>" . $row['U_First_Reason'] . "</td>
          <td>" . $row['U_Second_Reason'] . "</td>
<td>" . $row['U_Blood_Group'] . "</td>
<td>" . $row['U_Amount_Blood'] . "</td>
...
";
                                            ...
                                            $qry = "select * from Destroy_Blood_Unit where U_Destruction_Date = '$d'   ";
                                            $result = mysqli_query($conn, $qry);
