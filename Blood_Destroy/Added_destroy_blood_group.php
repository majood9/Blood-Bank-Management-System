                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="#" method="post">
                                        ...
                                        if ($_SERVER["REQUEST_METHOD"] === "POST") {
                                            ...
                                            $qry = "select * from Destroy_Blood_Group where Donation_Number = '$Donation_Number' ";
                                            ...
                                            if ($result->num_rows == 0) {
                                                // if ($Expiry_Date <= date('Y-m-d')) {
                                                    ...
                                                    $qry = " insert into Destroy_Blood_Group (B_Destruction_Number, B_Destruction_Date, B_First_Reason, B_Second_Reason,B_Blood_Group, B_Amount_Blood, Donation_Date,Donation_Number) values ('$Destruction_Number','$Destruction_Date','$First_Reason','$Second_Reason', '$Blood_Group', '$Amount_Blood','$Donation_Date','$Donation_Number') ";
                                                    $result = mysqli_query($conn, $qry); // تنفيذ الاستعلام

                                                    if (!$result) {

                                                        echo "<div style='text-align: center'><h4>SUBMITTED FAILED (<span style='color:blue;'>$Donation_Number</span>), Database Not Entered  </h4>";
                                                        echo '<h5><a href="Add_Release_By_QR Code.php" style="color: red; text-decoration: none;">Enter QR Code Again?</a></h5> ';
                                                    } else {
                                                        echo "<div style='text-align: center'><h4>SUBMITTED SUCCESSFULLY (<span style='color:blue;'>$Donation_Number</span>) </h4>";
                                                        echo '<h5><a href="destroy_blood_group_by_QR_Code.php" style="color: red; text-decoration: none;">Enter QR Code Again?</a></h5> ';
                                                        // $q = "UPDATE blood set Donation_Number = '$Destruction_Number' where Donation_Number = '$Donation_Number'";
