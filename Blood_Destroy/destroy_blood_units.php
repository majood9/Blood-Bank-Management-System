                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <form role="form" action="Added_destroy_blood_unit.php" method="post">
                                                <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                                    ...
                                                    <input style="flex: 1; margin-left: 500px;" class="form-control" type="hidden" name="national_id" readonly>
                                                </div><br>
                                                <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                                ...
                                                <div class="form-group" style="display: flex; flex-direction: row; direction: rtl;">
                                                    ...
                                                    <select placeholder="سبب الإتلاف" style="text-align: center;flex: 1; margin-left: 503px; color:darkred;" class="form-control" ; name="First_Reason" ; type="text" required><br><br>
                                                        ...
                                                        <option value="Expiry"><span>إنتهاء في الصلاحية</span></option>
                                                        <option value="Poor Storage"><span>سوء في التخزين</span></option>
                                        ...
                                        <label style="flex: 1; padding: 7px;" hidden>national</label>
                                        <input style="flex: 1; margin-left: 500px;" class="form-control" type="hidden" name="Expiry_Date" value="<?php echo $Expiry_Date ?>" readonly>
                     
                                        <label style="flex: 1; padding: 7px;" hidden>national</label>
                                        <input style="flex: 1; margin-left: 500px;" class="form-control" type="hidden" name="Amount_Blood" value="<?php echo $Amount_Blood ?>" readonly>
                     
                                        <label style="flex: 1; padding: 7px;" hidden>national</label>
                                        <input style="flex: 1; margin-left: 500px;" class="form-control" type="hidden" name="Blood_Group" value="<?php echo $Blood_Group ?>" readonly>
